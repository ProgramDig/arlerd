...
const FormRegistration = ({
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        await registrationHandler("http://localhost:5000/api/auth/registration",userDTOForm)
    }
                    ...
                    <div className="col m12 l12">
                        <div className="input-field">
                            <input id="rePassword"
                                   ...
                                   onChange={onChangeInput}
                            />
                            <label htmlFor="rePassword"><b>Підтвердження паролю </b><span style={{color : 'red'}}>*</span></label>
                        </div>
                    </div>
